...
report_sxw.report_sxw('report.account.account.balance1', 'account.account', 'addons/retention/report/account_balance.rml', parser=account_balance, header="internal")
