...
<body>
  ...
  <table class="header_invoice" >
    ...
    <tr>
	<td style="font-size:10;">${o.address_id.street and o.address_id.street or '*'} ${o.address_id.street2 and o.address_id.street2 or ''}</td>
	<td></td>
  ...
  <table width="100%" class="invoice_line">
    ...
    <tr>
      ...
      <td width="15%" style="text-align:left">${line.tax_code_id.code or ''}</td>
